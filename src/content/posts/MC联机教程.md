...
image: ../../assets/images/MC联机教程/MC联机教程封面.jpg
...
![图片](../../assets/images/MC联机教程/MC1.png)

2. 进入后便可以看到**游戏版本**和**加载器**，比如我这里**游戏版本**为**1.21.1**，**加载器**为**neoforge**

![图片](../../assets/images/MC联机教程/MC2.png)

3. 确定**游戏版本**和**加载器**后，点击左上角返回到PCL主页面，点击**下载**，**Mod**，搜索**更高级联机设置**，随后点击模组进入模组下载页面

```md
更高级联机设置
```

![图片](../../assets/images/MC联机教程/MC3.png)

4. 找到**刚刚确定**的**游戏版本**和对应的模组**加载器**，选择下载即可
...
:::important
**不同的游戏版本可能会导致该模组的配置页面有些许不同**，您只需要配置**正版验证：禁用+修复UUID**即可
:::

![图片](../../assets/images/MC联机教程/MC9.png)

6. 随后[配置astral-game](https://acg-n.cn/posts/AstralGame使用教程/#电脑使用astral创建和加入房间)

7. 如果没有在多人游戏显示房间，那么配置完成后房员手动输入房主的**ip:端口**即可

:::important
这里的**冒号为英文**（:），请**不要使用中文冒号**（：）
:::

:::tip
25565端口可以直接使用房主的ip连接，无需添加冒号和端口号
:::
...
:::important
在教程开始之前，**我不建议使用手机作为房主**，因为Java版在手机上以转译为主，性能释放受限
:::
...
![图片](../../assets/images/MC联机教程/MC8.png)
...
5. 如果没有在多人游戏显示房间，那么配置完成后房员手动输入房主的**ip:端口**即可
